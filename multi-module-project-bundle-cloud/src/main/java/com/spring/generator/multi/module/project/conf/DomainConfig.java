...
@EnableJpaRepositories(basePackages = {"com.spring.generator.multi.module.project.core.domain"})
public class DomainConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] {"com.spring.generator.multi.module.project.core.domain.model"});
